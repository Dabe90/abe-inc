# Year 4–5 — Month 09: Customer discovery interviews (5)
...
- **Do:** Produce an artifact for **Customer discovery interviews (5)** (memo, policy, scorecard, or customer notes)
...
## LinkedIn
Post about **Customer discovery interviews (5)** with one concrete artifact screenshot (redact secrets).
