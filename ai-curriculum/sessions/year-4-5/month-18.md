# Year 4–5 — Month 18: Case study with metrics
...
- **Do:** Produce an artifact for **Case study with metrics** (memo, policy, scorecard, or customer notes)
...
## LinkedIn
Post about **Case study with metrics** with one concrete artifact screenshot (redact secrets).
