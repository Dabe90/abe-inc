# Year 4–5 — Month 15: Legal basics consult (notes only)
...
- **Do:** Produce an artifact for **Legal basics consult (notes only)** (memo, policy, scorecard, or customer notes)
...
## LinkedIn
Post about **Legal basics consult (notes only)** with one concrete artifact screenshot (redact secrets).
