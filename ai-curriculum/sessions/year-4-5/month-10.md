# Year 4–5 — Month 10: Roadmap 12 months (tech + product)
...
- **Do:** Produce an artifact for **Roadmap 12 months (tech + product)** (memo, policy, scorecard, or customer notes)
...
## LinkedIn
Post about **Roadmap 12 months (tech + product)** with one concrete artifact screenshot (redact secrets).
