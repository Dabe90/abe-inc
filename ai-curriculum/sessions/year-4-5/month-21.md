# Year 4–5 — Month 21: P10 build sprint
...
- **Do:** Produce an artifact for **P10 build sprint** (memo, policy, scorecard, or customer notes)
...
## LinkedIn
Post about **P10 build sprint** with one concrete artifact screenshot (redact secrets).
