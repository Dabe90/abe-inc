# Year 4–5 — Month 11: Capital strategy: bootstrap vs raise
...
- **Do:** Produce an artifact for **Capital strategy: bootstrap vs raise** (memo, policy, scorecard, or customer notes)
...
## LinkedIn
Post about **Capital strategy: bootstrap vs raise** with one concrete artifact screenshot (redact secrets).

## Project
Advance P10 prerequisites (policy, roadmap, customers).
