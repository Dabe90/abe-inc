# Year 4–5 — Month 17: Refine ICP (enterprise vs SMB)
...
- **Do:** Produce an artifact for **Refine ICP (enterprise vs SMB)** (memo, policy, scorecard, or customer notes)
...
## LinkedIn
Post about **Refine ICP (enterprise vs SMB)** with one concrete artifact screenshot (redact secrets).
