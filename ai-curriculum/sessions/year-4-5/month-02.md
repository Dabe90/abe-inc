# Year 4–5 — Month 02: YC Startup School start
...
- **Do:** Produce an artifact for **YC Startup School start** (memo, policy, scorecard, or customer notes)
...
## LinkedIn
Post about **YC Startup School start** with one concrete artifact screenshot (redact secrets).
