# Year 4–5 — Month 07: Advisor/board update memo
...
- **Do:** Produce an artifact for **Advisor/board update memo** (memo, policy, scorecard, or customer notes)
...
## LinkedIn
Post about **Advisor/board update memo** with one concrete artifact screenshot (redact secrets).
