...
const outDir = path.join(__dirname, '..', 'images', 'screenshots', 'prayer-city-social');
const baseUrl = 'https://social.prayercityhtx.com';
...
const shots = [
  ...
  { name: 'editor', url: `${baseUrl}/editor`, viewport: { width: 1440, height: 900 }, fullPage: false },
  { name: 'dashboard', url: `${baseUrl}/dashboard`, viewport: { width: 1440, height: 900 }, fullPage: false },
];
